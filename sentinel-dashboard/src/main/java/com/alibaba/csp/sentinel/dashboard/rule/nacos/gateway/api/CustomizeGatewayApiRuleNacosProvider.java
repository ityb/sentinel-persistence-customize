 ...
 * @since 1.4.0
 */
@Component("customizeGatewayApiRuleNacosProvider")
public class CustomizeGatewayApiRuleNacosProvider implements DynamicRuleProvider<List<ApiDefinitionEntity>> {
