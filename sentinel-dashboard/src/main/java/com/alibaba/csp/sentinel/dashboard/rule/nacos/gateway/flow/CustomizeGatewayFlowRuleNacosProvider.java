 ...
 * @since 1.4.0
 */
@Component("customizeGatewayFlowRuleNacosProvider")
public class CustomizeGatewayFlowRuleNacosProvider implements DynamicRuleProvider<List<GatewayFlowRuleEntity>> {
