 ...
 * @since 1.4.0
 */
@Component("customizeGatewayFlowRuleNacosPublisher")
public class CustomizeGatewayFlowRuleNacosPublisher implements DynamicRulePublisher<List<GatewayFlowRuleEntity>> {
    ...
    public void publish(String app, List<GatewayFlowRuleEntity> rules) throws Exception {
        nacosConfigUtil.setGatewayRuleString2Nacos(
                this.configService,
                app,
                dynamicConfig.getGatewayFlowDataIdPostfix(),
                rules
        );
    }
}
