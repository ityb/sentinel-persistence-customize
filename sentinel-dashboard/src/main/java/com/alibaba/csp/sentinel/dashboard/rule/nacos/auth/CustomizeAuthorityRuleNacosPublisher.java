...
@Component("customizeAuthorityRuleNacosPublisher")
public class CustomizeAuthorityRuleNacosPublisher implements DynamicRulePublisher<List<AuthorityRuleEntity>> {
